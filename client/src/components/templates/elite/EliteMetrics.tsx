...
const EliteMetrics: React.FC<EliteMetricsProps> = ({ socialLinks, isDark }) => {
    ...
    // Handle leetcode.com/username and leetcode.com/u/username
    let leetcodeUsername = null;
    if (leetcodeLink) {
        const parts = leetcodeLink.url.split('/').filter(Boolean);
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex items-end gap-4 mb-12">
                    <div className="p-3 bg-green-500/10 rounded-lg">
                        <GitCommit className="text-green-600 dark:text-green-500" size={24} />
                    </div>
                    <div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                    ...
                    {githubUsername && (
                        <motion.div 
                            ...
                            className="xl:col-span-2 group relative rounded-2xl bg-gray-50 dark:bg-[#0a0a0a] border border-black/5 dark:border-white/5 p-6 md:p-8 overflow-hidden hover:border-green-500/30 transition-colors"
                        >
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <div className="flex gap-1">
                                    <div className="w-2 h-2 rounded-sm bg-[#2ea44f]/20" />
                                    <div className="w-2 h-2 rounded-sm bg-[#2ea44f]/40" />
                                    <div className="w-2 h-2 rounded-sm bg-[#2ea44f]/60" />
                                    <div className="w-2 h-2 rounded-sm bg-[#2ea44f]/80" />
                                    <div className="w-2 h-2 rounded-sm bg-[#2ea44f]" />
                                </div>
                            </div>

                            <div className="relative w-full overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-white/10">
                                {/* Using Green palette (2ea44f) */}
                                <img 
                                    src={`https://ghchart.rshah.org/2ea44f/${githubUsername}`} 
                    ...
                    {leetcodeUsername && (
                        <motion.div 
                            ...
                            className="xl:col-span-1 rounded-2xl bg-gray-50 dark:bg-[#0a0a0a] border border-black/5 dark:border-white/5 p-6 md:p-8 flex flex-col justify-between hover:border-orange-500/30 transition-colors"
                        >
                            ...
                            <div className="flex-1 flex items-center justify-center">
                                {/* LeetCard handles LeetCode API data visualization */}
                                <img 
