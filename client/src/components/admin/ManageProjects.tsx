    ...
    <div>
      ...
      <div className="p-6 bg-white dark:bg-slate-800/50 rounded-lg shadow-md mb-8">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input name="title" value={formData.title} onChange={handleChange} placeholder="Title" className="p-2 border rounded dark:bg-slate-700 dark:border-slate-600" />
          <input name="imageUrl" value={formData.imageUrl} onChange={handleChange} placeholder="Image URL" className="p-2 border rounded dark:bg-slate-700 dark:border-slate-600" />
          ...
          <div className="md:col-span-2 flex items-center space-x-2">
            <button type="submit" className="px-4 py-2 font-semibold text-white bg-sky-500 rounded-lg hover:bg-sky-600">{editingIndex !== null ? 'Update Project' : 'Add Project'}</button>
