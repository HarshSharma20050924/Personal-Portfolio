        ...
        <div className="max-w-2xl">
                ...
                <div className="flex items-start gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                            Register this device (Fingerprint, FaceID, or USB Security Key) to log in without a password in the future.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    {status === 'success' ? (
                        <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 rounded-xl border border-green-100 dark:border-green-900/30">
                            ...
                            <span className="text-sm font-medium">Biometric credential registered successfully!</span>
                        </div>
                    ) : status ? (
                    ...
                    >
                        {isRegistering ? 'Interfacing with Device...' : 'Register This Device'}
                    </button>
                </div>
            </div>
            ...
            <div className="mt-8 p-6 bg-slate-50 dark:bg-slate-900/30 rounded-xl border border-dashed border-slate-200 dark:border-slate-700">
                 ...
                 <ul className="text-xs text-slate-500 space-y-1 list-disc ml-5">
                    <li>Only register devices you own and trust.</li>
                    <li>Biometric data never leaves your device or browser.</li>
                    <li>You can always use your password as a backup.</li>
                 </ul>
            </div>
        </div>
    );
